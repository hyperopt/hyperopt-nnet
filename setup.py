...
setuptools.setup(
    ...
    packages = packages,
    scripts = scripts,
    url = 'http://github.com/jaberg/hyperopt-nnet/',
    author = 'James Bergstra',
    author_email = 'anon@anon.com',
    description = 'Hyperparameter optimization for neural networks',
    ...
    keywords = 'hyperparameter model selection neural networks machine learning',
