...
Run this script like e.g.
    ...
    $ ipcluster start --n=2           # in shell 1
...
def main_rectangles(filename='iptrials_rectangles.pkl'):
...
def main_MRBI(filename='iptrials_MRBI.pkl'):
...
def main_convex(filename='iptrials_convex.pkl'):
